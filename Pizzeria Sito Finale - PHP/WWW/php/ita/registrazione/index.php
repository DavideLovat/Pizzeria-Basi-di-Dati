...
<div id="wrapper">
    ...
    <div id="subnavi">
		...
		?>
		<li class="active" style="float:right;"><a href="http://wwwstud.dsi.unive.it/dlovat/WWW/php/ita/registrazione/">Registrati</a></li>
        </ul>
    </div>
	...
	<div id="content" style="width:95%">
		<h1><span> Registrazione Nuovo Utente </span></h1>
		<?php require_once "form_utente.php"; ?>
       </div>
