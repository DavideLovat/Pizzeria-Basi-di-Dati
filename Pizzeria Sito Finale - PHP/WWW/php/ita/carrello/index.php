...
<!-- inzio script aggiunti -->	
	...
	<script>
		...
		$("#lista_cart").load("carica_cart.php");
	});
	</script>
...
<div id="wrapper">
    ...
    <div id="navi">
    	<ul>
        	...
        	<li class="active"><a href="http://wwwstud.dsi.unive.it/dlovat/WWW/php/ita/carrello/">Carrello</a></li>
			<?php
	...
	<div id="content" style="width:95%">
		<h1><span> Carrello Pizze </span></h1>
		<div id="lista_cart">
			<?php //require_once("carica_cart.php")?>
		</div>	
       </div>
